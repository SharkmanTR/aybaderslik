                            ...
                            <div className={t.sunum}>
                                {konular4.map(k4=>(
                                    <div key={k4.id} id={k4.id}>
                                        <a className={t.h2} href={"http://aybaderslik.com/dersdosyalari/"+k4.uni+"/"+k4.sinif+"/"+k4.ders+"/"+k4.id+".pdf"} download>{k4.konu}</a>
                            ...
                            <div className={t.sunum}>
                                {konular3.map(k3=>(
                                    <div key={k3.id} id={k3.id}>
                                        <a  className={t.h2} href={"http://aybaderslik.com/dersdosyalari/"+k3.uni+"/"+k3.sinif+"/"+k3.ders+"/"+k3.id+".pdf"} download={k3.konu}>{k3.konu}</a>
