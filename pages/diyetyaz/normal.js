    ...
    return(
        <div>
            ...
            <div className={t.main} >
                <div className={t.sec}>
                    <p className={t.p}>Formül:</p>
                    <select id='hesapfor' className={t.select3} onChange={hesap2}>
                        <option className={t.option3} value='pratik'>WHO Pratik Formül</option>
                        <option className={t.option3} value='hb'>Harris-Benedict Formülü</option>
                    </select>
                </div>
                <div className={t.sec}>
                ...
                <div className={t.sec}>
                    ...
                    <input id='hesapyas' className={t.inputsec} type="number" min="0" placeholder='Yaş (yıl)' onChange={hesap2}></input>
                </div>
                <div className={t.sec}>
